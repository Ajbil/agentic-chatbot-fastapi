...
system_prompt=st.text_area("Define the type of AI Agent you need like general, financial, educational, etc..  ", height=70, placeholder="Type your system prompt here...")

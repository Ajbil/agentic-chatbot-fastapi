...
| [07](checkpoints/07-auditable-search-evidence/README.md) | Auditable web search and source provenance | In review | [Draft PR #7](https://github.com/Ajbil/agentic-chatbot-fastapi/pull/7) |

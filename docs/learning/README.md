...
| [06](checkpoints/06-context-window-management/README.md) | Context budgeting and transparent recent-window trimming | In review | [Draft PR #6](https://github.com/Ajbil/agentic-chatbot-fastapi/pull/6) |

...
- Citation integrity success rate: 4/4 (100.00%)
...
Hard checks are deterministic repository invariants. Advisory checks use lexical proxies and do not prove factual correctness or helpfulness. Citation checks prove that references map to retrieved sources; they do not prove that each source semantically entails each claim.
